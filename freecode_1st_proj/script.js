 ...
 */
function clearAll() {
    const meme = document.querySelector('.meme1');
    const joke = document.querySelector('.joke1');
    const quote = document.querySelector('.quote1');
    const riddle= document.querySelector('.riddle1');
    meme.innerHTML = '';
    joke.innerHTML = '';
    quote.innerHTML = '';
    riddle.innerHTML = '';
...
function showMeme() {
    ...
    mem.setAttribute('src', randomMemeUrl);
    const parent = document.querySelector('.meme1');
    clearAll();   
...
function showJoke() {
    ...
    const jok_contain=document.querySelector('.joke1')
    const joke = document.createElement('p');
    joke.textContent = randomJokeText;
    clearAll();
    jok_contain.appendChild(joke);
}
...
function showQuote() {
    ...
    const qot_contain = document.querySelector('.quote1')
    clearAll();
    qot_contain.appendChild(quotes);
    qot_contain.appendChild(author);
...
function showRiddle() {
    ...
    const rid_contain = document.querySelector('.riddle1');
    const quest = document.createElement('p');
    const ans = document.createElement('p');
    quest.setAttribute('id', 'quest1');
    quest.textContent = randomRiddle.question;
    ans.textContent = randomRiddle.answer;
    ans.setAttribute('id','ans1');
    ans.hidden = true;
    clearAll();
    rid_contain.appendChild(quest);
    rid_contain.appendChild(ans);
...
function revealAnswers() { 
    const rid_contain = document.querySelector('.riddle1');
    const isRid = rid_contain.querySelector('#quest1');
    const ans = rid_contain.querySelector('#ans1');
    if (isRid && ans.hidden)
        ans.hidden = false;
    else if (isRid) {
        alert('answer is revealed already');
    }
    else {
